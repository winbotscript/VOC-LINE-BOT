...
<html lang="th">
	...
	<body> 
		<?php
			...
			$sql = "SELECT main_office, COUNT(main_office) AS NUM FROM tbl_complaint  WHERE office_code like 'H%' AND number_of_day>=".$datenum." AND complaint_status <> 'ปิด' GROUP BY main_office HAVING(COUNT(office_name)>0)";
			// }
